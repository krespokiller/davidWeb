...
export const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      'Implemented an intercom system leveraging WebRTC for real-time communication.',
      'Configured and managed TURN/STUN servers to guarantee connection stability.',
      'Integrated WebSockets for efficient peer-to-peer communication.',
  ...
  },
  {
    ...
    location: 'Remote',
    description: [
      'Developed a discreet sex-shop e-commerce platform using WordPress and WooCommerce.',
